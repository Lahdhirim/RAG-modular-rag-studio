...
from src.rag.parsing.base_parser import BaseParser
...
class DoclingParser(BaseParser):
    ...
    def __init__(
        ...
        logger.info(f"Using device: {self.device} | OCR mode: {ocr}")

        selected_languages = self.params.get(
            "languages",
            ["en"],
        )
        logger.info(f"Selected OCR languages: {selected_languages}")
